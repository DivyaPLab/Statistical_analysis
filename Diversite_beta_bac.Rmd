...
varpart_result <- varpart(ASV_table, ~ Moy_DIC, ~ Moy_NH4, data = Meta_filters_all)
...
varpart_result <- varpart(ASV_table, ~ X.IronOxide, ~X.Quartz, ~ X.RedFeldpath + X.WhiteFeldpath, ~ X.Mica , data = meta_mineral)
varpart_result
