...
colors = c("#264653", "#BFD7EA","#A0785A","#2a9d8f","#FF7C80","#77BC48","#FDB750","#F9853D","#9E0000","#ffd899","#936FAC") 
my_scale=scale_fill_manual(name=as.character(unique_sources), values = colors, na.translate=FALSE, drop=FALSE, limits = force)


# Saving the color palette for future use 
#saveRDS(palette, "/home/dpatel/sequences/bac/colors_class.rds")

# Plot
Phylum_Filters <- df[(df$SampleType == "Filtre"), ]
Phylum_Filters$Sample <- gsub("F-", "", Phylum_Filters$Sample)

Phylum_Filters$Sample <- factor(Phylum_Filters$Sample, c("P1","P2","P3","P4","Tourb",
                              "B-J1","B-J2","B-J3","B-J4","B-J5","B-J6","B-J7","B-J8","B-J9","B-J11",
                              "J-J1","J-J2","J-J3","J-J4","J-J5","J-J6","J-J7","J-J8","J-J9","J-J11",
                              "R-J1","R-J2","R-J3","R-J4","R-J5","R-J6","R-J7","R-J8","R-J9","R-J10")) 


bac_Phylum=ggplot(Phylum_Filters, aes(x=Sample, weight=Abundance, fill=.data[[taxa_rank]])) +
  geom_bar() +
  ...
  facet_grid(cols = vars(Phylum_Filters$Bioreacteur), scales="free", margins = FALSE, drop = F) +
  ggtitle(" ")
  
  
bac_Phylum
#ggsave("sequences/Bac/bac_Figures/Bac_Filtre_Phylum.pdf", width = 24, height = 12, plot = last_plot())


```

##### Plot PHYLUM for ROCKS
```{r}
# Plot
Phylum_Rocks <- df[(df$SampleType == "Roche"),] 
Phylum_Rocks$Sample <- gsub("R-", "", Phylum_Rocks$Sample)

Phylum_Rocks$Sample <- factor(Phylum_Rocks$Sample, c("B1B","B5B","B7B","B8B","B2M","B3M","B4M","B6M","B1H","B3H","B6H","B7H",
                                                   "J3B","J7B","J8B","J1M","J3M","J7M","J8M","J2H","J4H","J6H",
                                                   "R1B","R2B","R5B","R7B","R2M","R3M","R6M","R7M","R1H","R4H","R5H","R8H"))


bac_Phylum=ggplot(Phylum_Rocks, aes(x=Sample, weight=Abundance, fill=.data[[taxa_rank]])) +
  geom_bar() +
  ...
  my_scale + 
  guides(fill=guide_legend(title="Phylum")) +
  facet_grid(cols = vars(Phylum_Rocks$Bioreacteur), scales="free", margins = FALSE, drop = F) +
  ggtitle(" ")
  
  
bac_Phylum
#ggsave("sequences/Bac/bac_Figures/Bac_Roche_Phylum.pdf", width = 24, height = 12, plot = last_plot())
